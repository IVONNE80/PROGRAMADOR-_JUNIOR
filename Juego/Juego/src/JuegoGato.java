...
public class JuegoGato {
    ...
    public void indicarTurno() {
        System.out.println(
                "JUGADOR " + (getTurno() ? "1" : "2") + ": Elija Una Casilla Ingresando El Numero Correspondiente.");
        /*
         * if(getTurno()==true) {
         * System.out.
         * println("JUGADOR 1: Elija Una Casilla Ingresando El Numero Correspondiente."
         * );
         * } else {
         * System.out.
         * println("JUGADOR 2: Elija Una Casilla Ingresando El Numero Correspondiente."
         * );
         * }
         */
    }
    ...
    public void cambiarTurno() {
        ...
        /*
         * if(obtenerFigura()=='X') {//Si el Metodo regresa un valor char igual a "X"
         * cambia el valor de "turno" a "false".
         * setTurno(false);
         * } else {
         * setTurno(true);
         * }
    ...
    public void jugarGato() {
        ...
        do {
            ...
            try {
                ...
                System.out.println("ERROR!: Ingreso Un Caracter No Valido, Por Favor, Intente Nuevamente JUGADOR "
                        + (getTurno() ? "1" : "2"));
                /*
                 * if(getTurno()==true) {
                 * System.out.
